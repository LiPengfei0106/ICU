...
object PermissionUtils {
     ...
     * 第一步. 检查权限
     */
    fun checkPermission(activity: Activity, permissionList: Array<String>, callBack: Runnable) {
        var allGranted = true
        permissionList.forEach {
            val result = ContextCompat.checkSelfPermission(activity, it)
            Timber.d("检查权限 $it   结果 $result")
     ...
     */
    private fun startRequestPermission(activity: Activity, permissionList: Array<String>) {
        ...
        permissionList.forEach {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, it)) {
                ...
                Timber.d("  showPermissionExplainDialog()")
     ...
     *  第三步. 请求权限
     */
    private fun requestPermission(activity: Activity, permissionList: Array<String>) {
     ...
     */
    private fun showPermissionExplainDialog(activity: Activity, permissionList: Array<String>) {
